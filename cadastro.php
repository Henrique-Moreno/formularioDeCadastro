...
$usuario = new \App\Projeto\Usuario($_POST['nome'], $_POST['senha'], $_POST['genero']);
$contato = new \App\Projeto\Contato($_POST['email'], $_POST['endereco'], $_POST['cep'], $_POST['telefone']);
